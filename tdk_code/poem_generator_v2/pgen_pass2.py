...
for poem in tqdm(poems, desc="Generating poems", leave=False):
    ...
    try:
        ...
        if response.text:
            generated_poems.append({"text": response.text.strip(), "label": "machine"})
        ...
        try:
            ...
            # Generate a poem by explicitly asking to avoid inapproriate content
            ...
            generated_poems.append({"text": filtered_poem.text.strip(), "label": "machine"})
            ...
            generated_poems.append({"text": poem.text.strip(), "label": "machine"})
...
combined_poems.extend(generated_poems)
